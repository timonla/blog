...
what I consider, a healthy diet, without growing my own vegetables or having to compromise on non-organic food.

I am also interested in the Omega 3/6 ration as I have not checked this for a while.
...
This list is by no means *static* or *final* but at the time of writing this:
* I am following a vegan diet for both ethic and health related reasons
...
* Time of every food preparation performed
* Time of every meal
* Photo of every meal
* The first time I prepare a meal I will provide some more information on why I am eating this and how I am preparing it
* Grams for every ingredient (except spices) in [cronometer](https://cronometer.com/)
* Price per kg in Euro and SEK of every ingredient in Gothenburg/Sweden
* Calories burned

I am using [this scale](https://www.amazon.de/gp/product/B017NZNKYW/ref=ppx_yo_dt_b_asin_title_o02_s00?ie=UTF8&psc=1) which is not
super accurate when it comes to differences of single grams.
...
So there won't be as much meal prep as I might have done half a year ago.
However, considering the situation in the world right now, it's probably not as relevant as it used to be.
...
One bottle contains 1700 drops of which I consume 5 per day (1000 mcg).
Hence, the bottle will last for 340 days, resulting in **0.07 EUR/0.70 SEK** per day.

The drops that I currently use still have an alcohol base, unlike the ones listed on amazon right now.

Make sure that you are buying B12 drops with **Methylcobalamin**.
...
One bottle contains 1700 drops of which I consume 5 per day (125 mcg D3, 100 mcg K2).
Hence, the bottle will last for 340 days, resulting in **0.06 EUR/0.67 SEK** per day.
...
As spices I added: tumeric, coriander, ginger, chili, smoked paprika and cinamon.

Once the lentils are ready, I wait for it to cool down a slight bit, mix the starch with a hint of
water and then add it to the pot while stiring.
